...
class _MyAppState extends State<MyApp> {
  ...
  final String model = 'assets/im_all_ears.tflite';
  final String label = 'assets/im_all_ears.txt';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        home: Scaffold(
            key: _scaffoldKey,
            appBar: AppBar(
              title: const Text("CPSC 581 - I'm All Ears"),
              actions: <Widget>[
                Padding(
