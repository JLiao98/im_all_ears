...
class _MyAppState extends State<MomentsPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: TitleAppBar('Hearing the moments'),
...
_OrderInfo _data(int id) => _OrderInfo(
      ...
      deliveryProcesses: [
        _DeliveryProcess(
          'Home Household',
          messages: [
            _DeliveryMessage('8:30am', 'Alarm Sound'),
            _DeliveryMessage('11:30am', 'Door Knock Sound'),
          ],
        ),
        _DeliveryProcess(
          'Outside',
          messages: [
            _DeliveryMessage('13:00pm', 'Bell Ring Sound'),
            _DeliveryMessage('15:35pm', 'Someone calls your name'),
          ],
        ),
